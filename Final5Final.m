...
function [reconstructionError, filteredSignals] = filterAndReconstruct1DFunction(f, gaborBank, lowpass)
...
[reconstructionError, filteredSignals] = filterAndReconstruct1DFunction(f, gaborBank, lowpass);
