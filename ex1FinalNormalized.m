...
function [reconstructionError, reconstructedSignal, filteredSignals] = filterAndReconstruct1DFunction(f, gaborBank, lowpass)
...
[reconstructionError, reconstructedSignal, filteredSignals] = filterAndReconstruct1DFunction(f, gaborBank_normalized, lowpass_normalized);
...
disp(['Sum of Lowpass Filter: ' num2str(sum(lowpass_normalized))]);
